Public Class BuildAsset
    ...
    Private Sub dgview_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgview.CellClick
        ...
        If e.ColumnIndex = 2 Then
            ...
            InventoryClass.SavePropertyCode(dgview.Rows(row).Cells(14).Value.ToString, dgview.Rows(row).Cells(15).Value.ToString, dgview.Rows(row).Cells(16).Value.ToString)
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        If SimpleButton1.Text = "Record" Then
            ...
            Dim entryno As String = InventoryClass.FetchEntryno
            InventoryClass.SaveBuildHeader(entryno, DateTimePicker1.Value, TextBox1.Text, Home.EmployeeID)
            ...
            For Each row As DataGridViewRow In dgview.Rows
                If Not row.IsNewRow Then
                    ...
                    Dim Keeper As String = row.Cells(17).Value.ToString
                    Dim Owner As String = row.Cells(18).Value.ToString
                    Dim Borrower As String = "0"
                    Dim BorrowerStat As String = "Not Allowed"
                    Dim Ref As String = row.Cells(9).Value.ToString
                    Dim Refno As String = row.Cells(10).Value.ToString
                    Dim Condition As String = row.Cells(11).Value.ToString
                    Dim stat1 As String = ""
                    Dim stat2 As String = ""

                    Dim headerid As Integer = InventoryClass.FetcHeaderID

                    InventoryClass.SaveAssetInventory(Integer.Parse(AssetCode), Class1, PropertyCode, Des, Double.Parse(Qty), Integer.Parse(Keeper),
                                                       Integer.Parse(Owner), Integer.Parse(Borrower), Ref, Refno, BorrowerStat, stat1, stat2, Condition)

                    InventoryClass.SaveBuildDetail(Integer.Parse(AssetCode), Class1, PropertyCode, Des, Double.Parse(Qty), Integer.Parse(Keeper),
            ...
            Label2.Visible = True
            Label2.Text = InventoryClass.FetchEntryn1
