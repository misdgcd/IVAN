        ...
        Try
            ...
            Try
                If reqst = True Then
                    ...
                    RequestHeaderClass.ViewEmployeeList5(emplid2)
                ...
                ElseIf reqst = False Then
                    ...
                    dgview.Columns.Add("0", "Asset Code")
                    dgview.Columns.Add("1", "Asset Description")
                    dgview.Columns.Add("2", "Reference")
                    dgview.Columns.Add("3", "Reference No.")
                    dgview.Columns.Add("4", "Quantity")
                    'GETS THE VALUE ID'

                    dgview.Columns.Add("5", "AssetID")
                    dgview.Columns.Add("6", "InvID")
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Dim venid As Integer = vendorID
            ...
            For Each row As DataGridViewRow In dgview.Rows
                ...
                Dim AssetId As String = row.Cells(4).Value.ToString



                Dim TransHeaderID As Integer = AssetHeaderClass.FetchTransHeaderID
                AssetDetailClass.SaveAssetDetail(Integer.Parse(AssetId), AssetCode, ref, refno, Double.Parse(qty), TransHeaderID, venid, mod1)
