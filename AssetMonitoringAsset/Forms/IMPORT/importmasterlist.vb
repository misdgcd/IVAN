        ...
        Try
            ...
            For Each row As DataGridViewRow In dgv.Rows
                ...
                If Not row.IsNewRow Then
                    ...
                    Dim AH As String = "0"
                    MasterdataDetailsClass.SaveAssetDetail2(Itemcode, Description, Integer.Parse(Category), Integer.Parse(Type), Date.Parse(date1), Date.Parse(date2), Integer.Parse(user1), Integer.Parse(user2), Integer.Parse(AH))
                End If
            Next
