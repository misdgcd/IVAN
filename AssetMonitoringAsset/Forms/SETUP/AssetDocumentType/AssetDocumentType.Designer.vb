...
Partial Class AssetDocumentType
    ...
    Private Sub InitializeComponent()
        ...
        Me.SimpleButton1.Text = "New Doc. Type"
        '
        'TextBox2
        '
        ...
        Me.Label2.Text = "Doc. Type  Description :"
        '
        'Label1
        '
