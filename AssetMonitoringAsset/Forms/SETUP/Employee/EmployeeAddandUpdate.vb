    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Else
            If SimpleButton1.Text = "Record" Then
                ...
                Else
                    EmployeeClass.SaveEmployee(TextBox1.Text, TextBox2.Text, Integer.Parse(branID), Integer.Parse(DepID), Integer.Parse(PosID), Integer.Parse(SecID), Integer.Parse(ManagerID1), ComboBox6.Text)
                End If

            ElseIf SimpleButton1.Text = "Save" Then
                EmployeeClass.UpdateEmployee(updateID, TextBox1.Text, TextBox2.Text, Integer.Parse(branID), Integer.Parse(DepID), Integer.Parse(PosID), Integer.Parse(SecID), Integer.Parse(ManagerID1), ComboBox6.Text)
            End If
        End If
